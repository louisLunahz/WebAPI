       ...
       public static  void Main(string[] args)
        {
         ...
         //   ConsumeEventSync consumeEventSync = new ConsumeEventSync();
         //List<Product> products=consumeEventSync.GetAllEventData<Product>("product").Result;
        ...
        //    ConsumeEventSync consumeEventAsync = new ConsumeEventSync();
        //    consumeEventAsync.GetOne("person/authenticate");
